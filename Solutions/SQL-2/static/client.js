...
`;
  ...
  date.innerHTML = `
<span>date:  </span>
<span class="value">${agent.dateReceived}</span>
`;
...
updateBtn.addEventListener("click", async () => {
  let body = {
    ...
    dateReceived: reverseDate(dateForm.value, "/"),
...
function reverseDate(date, del = "-") {
  return date.split(/\/|\-/).reverse().join(del);
}
